...
import type { Article } from "../services/weddingBoutiquePhuketService";
...
const WeddingBoutiquePhuketHome: React.FC<HomeProps> = ({
  articles,
  onNext,
  onPrevious,
  currentPage,
...
export default WeddingBoutiquePhuketHome;