...
import type { Article } from "../services/legallyMarriedInThailandService";
...
const LegallyMarriedInThailandHome: React.FC<HomeProps> = ({
  articles,
  onNext,
  onPrevious,
  currentPage,
...
export default LegallyMarriedInThailandHome;