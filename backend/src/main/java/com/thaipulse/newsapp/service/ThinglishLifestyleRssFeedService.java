...
@Service
public class ThinglishLifestyleRssFeedService {

    private static final Logger logger = LoggerFactory.getLogger(ThinglishLifestyleRssFeedService.class);

    private final ThinglishLifestyleNewsRepository thinglishLifestyleNewsRepository;

    public ThinglishLifestyleRssFeedService(ThinglishLifestyleNewsRepository thinglishLifestyleNewsRepository) {
    ...
    public List<ThinglishLifestyleNews> getNewsFromRss(String rssUrl) {
        List<ThinglishLifestyleNews> newsList = new ArrayList<>();
        try {
            ...
            for (SyndEntry entry : feed.getEntries()) {
                ...
                newsList.add(news);
                logger.info("Added ThinglishLifestyleNews: " + news.getTitle());
            }
