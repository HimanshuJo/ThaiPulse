...
@Service
public class ThaiCapitalistRssFeedService {

    private static final Logger logger = LoggerFactory.getLogger(ThaiCapitalistRssFeedService.class);

    private final ThaiCapitalistNewsRepository thaiCapitalistNewsRepository;

    public ThaiCapitalistRssFeedService(ThaiCapitalistNewsRepository thaiCapitalistNewsRepository) {
    ...
    public List<ThaiCapitalistNews> getNewsFromRss(String rssUrl) {
        List<ThaiCapitalistNews> newsList = new ArrayList<>();
        try {
