...
@Service
public class FashionGalleriaRssFeedService {

    private static final Logger logger = LoggerFactory.getLogger(FashionGalleriaRssFeedService.class);

    private final FashionGalleriaNewsRepository fashionGalleriaNewsRepository;

    public FashionGalleriaRssFeedService(FashionGalleriaNewsRepository fashionGalleriaNewsRepository) {
    ...
    public List<FashionGalleriaNews> getNewsFromRss(String rssUrl) {
        List<FashionGalleriaNews> newsList = new ArrayList<>();
        try {
