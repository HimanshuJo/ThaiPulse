...
import com.thaipulse.newsapp.dto.ThailandBailNewsDto;
...
@Service
public class ThailandBailRssFeedService {

    private static final Logger logger = LoggerFactory.getLogger(ThailandBailRssFeedService.class);

    private final ThailandBailNewsRepository thailandBailNewsRepository;

    public ThailandBailRssFeedService(ThailandBailNewsRepository thailandBailNewsRepository) {
    ...
    public List<ThailandBailNews> getNewsFromRss(String rssUrl) {
        List<ThailandBailNews> newsList = new ArrayList<>();
        try {
            URL url = new URL(rssUrl);
            SyndFeedInput input = new SyndFeedInput();
            SyndFeed feed = input.build(new XmlReader(url));
            for (SyndEntry entry : feed.getEntries()) {
                ThailandBailNews news = new ThailandBailNews();
