...
@Service
public class BudgetCatcherRssFeedService {

    private static final Logger logger = LoggerFactory.getLogger(BudgetCatcherRssFeedService.class);

    private final BudgetCatcherNewsRepository budgetCatcherNewsRepository;

    public BudgetCatcherRssFeedService(BudgetCatcherNewsRepository budgetCatcherNewsRepository) {
    ...
    public List<BudgetCatcherNews> getNewsFromRss(String rssUrl) {
        List<BudgetCatcherNews> newsList = new ArrayList<>();
        try {
            ...
            for (SyndEntry entry : feed.getEntries()) {
                ...
                newsList.add(news);
                logger.info("Added BudgetCatcherNews: " + news.getTitle());
